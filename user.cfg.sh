...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Данный скрипт содержит некоторые функции, которые  
# используются другими скриптами. Не предназначен 
# для непосредственого использования.
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
function check_no_root() {
	if [ "$(id -u)" = "0" ]
		then
			error_msg "Этот скрипт должен выполняться не с правами root."
	fi
}
